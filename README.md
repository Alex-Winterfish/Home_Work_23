...
Для проверки заполнить базу данных через фикстуры и выполнить кастомную команду add_group как описано в #Домашняя работа 28.

- Выполнены настройки для Ridus
- Настроена кеширование для отображения информации об одном продукте и низкоуровневое кеширование для списка продуктов
- Список продуктов получить, нажав на "Категории" в главном меню для получения списка категорий. Далее нажать "Продукты в категории" на карточке с категорией 
